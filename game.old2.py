...
def home():
    ...
    # game_numbers = [thisGame.numbers[thisGame.index][0], thisGame.numbers[thisGame.index][1]]
    # user1_game.index += 1
    
    # return render_template("home.html", thisUser = user1, user = User, user1 = user1, user2 = user2, info = 0, numbers = game_numbers)
